...
async def trade(
    self, action: str, amount, asset: str, duration, timeout: int = 5
    ...
    while self.api.trade_id is None:
        ...
        if time.time() - start_time > timeout:
            # Timeout reached, break the loop and return failure
            return False, {"error": "Timeout waiting for trade ID"}
